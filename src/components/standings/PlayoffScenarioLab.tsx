...
export default function PlayoffScenarioLab({ teams, games, playoffTeams, completedWeeks }: Props) {
  ...
  return <div className="space-y-5">
    ...
    <p className="text-xs text-[var(--muted)]">Odds use current records, points, scoring variance, remaining schedule, and {playoffTeams} configured playoff spots. They update as league results change.</p>
  </div>;
}
