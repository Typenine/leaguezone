      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <nav aria-label="Footer" className="flex flex-wrap items-center gap-x-5 gap-y-2 text-xs font-bold uppercase tracking-wider text-white/40">
            ...
            <Link href="/terms" className="hover:text-[var(--brand-gold)] transition-colors">Terms</Link>
        ...
        <p className="mt-6 border-t border-white/10 pt-4 text-xs leading-5 text-white/25">
          {PLATFORM.disclaimer} {PLATFORM.name} is currently an early beta — see our{' '}
          <Link href="/privacy" className="underline hover:text-white/40">Beta &amp; Privacy Notice</Link> and{' '}
          <Link href="/terms" className="underline hover:text-white/40">Beta Terms</Link>.
        </p>
      </div>
    </footer>
  );
