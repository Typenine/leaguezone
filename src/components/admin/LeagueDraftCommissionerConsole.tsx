        ...
        <>
          ...
          {draft.status !== 'COMPLETED' && (
            <section className="mt-4 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4 sm:p-5">
              ...
              <p className="mt-1 text-xs text-[var(--muted)]">Use only when the commissioner needs to enter a selection directly. The player must be in this draft's current eligible pool.</p>
